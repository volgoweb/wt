...
class CreateDateFieldMixin(models.Model):
    '''
    Абстрактная модель, содержащая поле создания сущности.
    '''
...
class CreatedUpdatedField(CreateDateFieldMixin):
    '''
...
class EntityBaseFields(CreatedUpdatedField, FieldsLabelsMixin):
    '''
